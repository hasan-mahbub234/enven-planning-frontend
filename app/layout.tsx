...
export const metadata: Metadata = {
  title: "Love Celebration by Lisa",
  description:
    "From intimate gatherings to grand celebrations, we deliver seamless wedding planning that's thoughtful, refined, and designed to bring your vision to life beautifully.",
  generator: "TopRatedDesingner",
};
