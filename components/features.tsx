      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="liquid-glass border border-white/20">
          <CardHeader>
            ...
            <CardTitle className="mt-1 text-xl text-white">
              Their work didn't just look good, it moved the needle — our
              audience felt the difference instantly.
            </CardTitle>
          </CardHeader>
          <CardContent>
